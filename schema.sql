...
(
    userID1 INTEGER NOT NULL, --fromID
    userID2 INTEGER NOT NULL, --toID
    requestText VARCHAR(200) DEFAULT 'You have a new friendRequest',
    ...
    CONSTRAINT FK_pendingFriend FOREIGN KEY (userID1) REFERENCES profile(userID), -- fromID
    CONSTRAINT FK_pendingFriend1 FOREIGN KEY (userID2) REFERENCES profile(userID) --toID
);
...
--CONSTRAINTS (MOVED FROM PREVIOUSLY SUBMITTED Constraints.sql file into Schema)
ALTER TABLE profile
